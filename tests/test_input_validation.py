...
class TestFilePathValidation:
    ...
    def test_path_traversal_attempts(self):
        ...
        assert (
            InputValidator.validate_file_path("/home/user/../../../etc/shadow") is False
        )
...
class TestStringSanitization:
    ...
    def test_remove_sql_keywords(self):
        ...
        # Sanitizer should warn and remove/modify SQL keywords
        # The exact behavior may vary, but string should be different/shorter
        assert (
            len(result) < len("SELECT * FROM users") or "select" not in result.lower()
        )
...
class TestConfigValidation:
    ...
    def test_invalid_timing_check_interval(self):
        ...
        config = {
            ...
            "timing": {"check_interval": -1},  # Invalid: negative
        }
