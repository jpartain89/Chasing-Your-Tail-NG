        ...
        for device in devices:
            ...
            try:
                ...
                if ssid and isinstance(ssid, str):
                    probes.append(
                        {"mac": mac, "ssid": ssid, "timestamp": device["last_time"]}
                    )
...
class SecureTimeWindows:
    ...
    def __init__(self, config: Dict[str, Any]):
        self.config = config
        self.time_windows = config.get("timing", {}).get(
    ...
    def filter_devices_by_ignore_list(
        self, devices: List[str], ignore_list: List[str]
    ) -> List[str]:
    ...
    def filter_ssids_by_ignore_list(
        self, ssids: List[str], ignore_list: List[str]
    ) -> List[str]:
